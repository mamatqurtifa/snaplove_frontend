    ...
    <div className="min-h-screen pt-20 flex flex-col items-center justify-center bg-gradient-to-b from-white to-[#FFF5F5] px-4 py-12">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800">Masuk ke SnapLove</h1>
          <p className="mt-2 text-gray-600">
            Masuk untuk menikmati semua fitur SnapLove
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="text-center text-sm text-gray-600">
            <p>
              Aplikasi ini hanya mendukung login dengan Google.
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-gray-600">
              Belum punya akun?{' '}
              <Link href="/auth/register" className="text-[#FF9898] font-semibold hover:text-[#FF7070]">
                Daftar Sekarang
              </Link>
            </p>
          </div>
